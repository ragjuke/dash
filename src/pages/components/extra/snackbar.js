          ...
          <Masonry columns={{ xs: 1, md: 2 }} spacing={3}>
            <Block title="Simple" sx={style}>
              <Button
                variant="contained"
                color="inherit"
                onClick={() => enqueueSnackbar('This is an default', { variant: 'default', action: () => {console.log('This is an default')} })}
              >
                Default
              </Button>
              <Button
                variant="contained"
                color="info"
                onClick={() => enqueueSnackbar('This is an info', { variant: 'info', action: () => {console.log('This is an info')} })}
              >
                Info
              </Button>
              <Button
                variant="contained"
                color="success"
                onClick={() => enqueueSnackbar('This is an success', { action: () => {console.log('This is a success')} })}
              >
                Success
              </Button>
              <Button
                ...
                onClick={() =>
                  enqueueSnackbar('This is an warning', {
                    variant: 'warning',
                    action: () => {console.log('This is a wawrning')},
                  })
                }
              >
                Warning
              ...
              <Button
                variant="contained"
                color="error"
                onClick={() => enqueueSnackbar('This is an error', { variant: 'error', action: () => {console.log('This is an error')} })}
              >
                Error
              </Button>
            </Block>
