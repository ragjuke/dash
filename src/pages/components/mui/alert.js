          ...
          <Masonry columns={2} spacing={3}>
            <Block title="Simple">
              <Stack spacing={2}>
                ...
                <Alert severity="warning" onClose={() => {console.log('warning')}}>
            ...
            <Block title="Filled">
              <Stack spacing={2}>
                <Alert variant="filled" severity="error" onClose={() => {console.log('error')}}>
                  This is an error alert — check it out!
                </Alert>
                <Alert variant="filled" severity="warning" onClose={() => {console.log('warning')}}>
                  This is a warning alert — check it out!
                </Alert>
            ...
            <Block title="Outlined">
              <Stack spacing={2}>
                <Alert variant="outlined" severity="error" onClose={() => {console.log('Error')}}>
                  This is an error alert — check it out!
                </Alert>
                <Alert variant="outlined" severity="warning" onClose={() => {console.log('warning')}}>
                  This is a warning alert — check it out!
                </Alert>
