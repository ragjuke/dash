...
const CoinTicker = () =>{
  ...
  return (
    ...
    <div id="btcChartBuild">
      {/* <div className="tradingview-widget-container" style={{ width: "300px !important" }}>
        <div className="tradingview-widget-container__widget" style={{ width: "300px !important" }}></div>
      </div> */}
    </div>
    );
}
