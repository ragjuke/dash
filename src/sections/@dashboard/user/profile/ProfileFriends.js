...
// @mui
import { Box, Grid, Card, Link, Avatar, IconButton, Typography, InputAdornment, MenuItem } from '@mui/material';
// components
  ...
  return (
    <Box sx={{ mt: 5 }}>
      ...
      <Typography variant="h6" sx={{ mb: 3, color: 'red' }}>
          You were referred by: {user?.referrer_name}
      </Typography>
      ...
      <Grid container spacing={3}>
        ...
        <Box sx={{ padding: '20px' }}>You do not have any referrals</Box>
        }
      </Grid>
